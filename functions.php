<?php
/**
 * PanaceaWP functions and definitions
 *
...
if ( ! function_exists( 'panacea_setup' ) ) :
	...
	function panacea_setup() {
		 ...
		 * If you're building a theme based on PanaceaWP, use a find and replace
...
function panacea_add_editor_style() {
	add_editor_style('dist/css/layout.css');
}
add_action('admin_init', 'panacea_add_editor_style');
